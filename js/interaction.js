    ...
    initCube = function () {
        ...
        for (j = 0; j < 8; j++) {
            for (i = 0; i < 8; i++) {
                if (i % 2 === 0) {
                    if (j % 2 === 0) {
                      // Replacing MeshBasic Material with MeshLambertMaterial
                        cube = new THREE.Mesh(new THREE.CubeGeometry(1.0, 0.2, 1.0), new THREE.MeshLambertMaterial({ color: 0xff0000, wireframe: false }));
                    } else {
                        cube = new THREE.Mesh(new THREE.CubeGeometry(1.0, 0.2, 1.0), new THREE.MeshLambertMaterial({ color: 0x000000, wireframe: false }));
                    }
                } else {
                    if (j % 2 === 0) {
                        cube = new THREE.Mesh(new THREE.CubeGeometry(1.0, 0.2, 1.0), new THREE.MeshLambertMaterial({ color: 0x000000, wireframe: false }));
